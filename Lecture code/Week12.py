...
# json.dump(mario, open("/workspaces/Data_3500_notes/Lecture code/mario.json", "w"))


mario_dict = json.load(open("/workspaces/Data_3500_notes/Lecture code/mario.json"))
print(mario_dict)
...
while True:
    ...
    if keep_going == "Y":
        if request_dict["type"] == "single":
            ...
            input("press enter to hear the punch line")
            print(request_dict["delivery"])
    else:
        print("Ok no more jokes.")
        break
